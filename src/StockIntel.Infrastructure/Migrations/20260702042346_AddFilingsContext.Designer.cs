...
namespace StockIntel.Infrastructure.Migrations
{
    ...
    [Migration("20260702042346_AddFilingsContext")]
    partial class AddFilingsContext
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StockIntel.Domain.Filings.InsiderTransaction", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_insider_transaction");

                    b.HasIndex("FilingId")
                        .HasDatabaseName("ix_insider_transaction_filing_id");

                    b.HasIndex("TransactionDate")
                        .HasDatabaseName("ix_insider_transaction_transaction_date");

                    b.ToTable("insider_transaction", (string)null);
                });
            ...
            modelBuilder.Entity("StockIntel.Domain.Filings.InsiderTransaction", b =>
                {
                    b.HasOne("StockIntel.Domain.Filings.InsiderFiling", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_insider_transaction_insider_filing_filing_id");
                });
