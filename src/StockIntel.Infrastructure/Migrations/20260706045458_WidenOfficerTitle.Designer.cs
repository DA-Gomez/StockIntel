...
namespace StockIntel.Infrastructure.Migrations
{
    ...
    [Migration("20260706045458_WidenOfficerTitle")]
    partial class WidenOfficerTitle
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StockIntel.Domain.Filings.CompanyTicker", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_company_tickers");

                    b.HasIndex("CompanyId")
                        .HasDatabaseName("ix_company_tickers_company_id");

                    b.HasIndex("Ticker")
                        .IsUnique()
                        .HasDatabaseName("ix_company_tickers_ticker");

                    b.ToTable("company_tickers", (string)null);
                });
            ...
            modelBuilder.Entity("StockIntel.Domain.Filings.CompanyTicker", b =>
                {
                    b.HasOne("StockIntel.Domain.Filings.Company", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_company_tickers_companies_company_id");
                });
            ...
            modelBuilder.Entity("StockIntel.Domain.Filings.InsiderFiling", b =>
                {
                    b.HasOne("StockIntel.Domain.Filings.Company", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_insider_filings_companies_company_id");
                });
